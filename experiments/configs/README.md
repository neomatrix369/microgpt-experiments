...
See [`docs/experiment-workflow.md`](../../docs/experiment-workflow.md#grid-sweep-automated-search) (includes a **finished `1_sweep-minimal.json` console excerpt**), **[Run timing](../../docs/experiment-workflow.md#run-timing-and-progress)**, [`example-experiments/sweep-1-minimal/`](../../example-experiments/sweep-1-minimal/) (checked-in `sweep_summary.csv` + `sweep_timing.txt`), [`docs/README.md`](../../docs/README.md), and [`docs/M2-semantic-quality.md`](../../docs/M2-semantic-quality.md).
