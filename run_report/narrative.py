...
def run_parameter_glossary_lines() -> list[str]:
    ...
    return [
        ...
        "  HEAD_DIM  — N_EMBD // N_HEAD. New reports: a # comment line under N_HEAD shows this for reading;",
        "            experiment tables omit it; parsers set HEAD_DIM on the in-memory config.",
